function [x_hat_new, P_new, probs_new, x_local_new, P_local_new, temp_vec_orig, probs_pred] = IMM_update_with_enforce(x_local_now, P_local_now, probs_now, y_new, models, TPM, prune_method, zero_numerical, enforce_zero)
